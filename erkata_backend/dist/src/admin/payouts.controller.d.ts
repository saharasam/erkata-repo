...
export declare class PayoutsController {
    ...
    getPendingPayouts(query: PaginationDto): Promise<({
        profile: {
            id: string;
            email: string;
            fullName: string;
    ...
    getGlobalLedger(query: PaginationDto, type?: AglpTransactionType, status?: AglpTransactionStatus, profileId?: string): Promise<({
        profile: {
            id: string;
            fullName: string;
