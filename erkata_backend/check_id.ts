...
async function main() {
  ...
  if (req) console.log('Found in Request table');
  if (match) console.log('Found in Match table');
  if (tx) console.log('Found in Transaction table');
  if (profile) console.log('Found in Profile table');
