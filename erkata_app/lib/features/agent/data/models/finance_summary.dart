class FinanceSummary {
  ...
  final double aglpPendingWithdrawals;
  ...
  FinanceSummary({
    ...
    required this.aglpPendingWithdrawals,
  ...
  factory FinanceSummary.fromJson(Map<String, dynamic> json) {
    return FinanceSummary(
      aglpBalance:
          (json['aglpBalance'] as num?)?.toDouble() ??
          (json['aglpAvailable'] as num?)?.toDouble() ??
          0.0,
      aglpPending: (json['aglpPending'] as num?)?.toDouble() ?? 0.0,
      aglpPendingWithdrawals:
          (json['aglpPendingWithdrawals'] as num?)?.toDouble() ?? 0.0,
