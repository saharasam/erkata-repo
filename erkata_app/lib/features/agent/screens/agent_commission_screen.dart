                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        _BalanceHero(
                          ...
                          pendingWithdrawals: summary.aglpPendingWithdrawals,
                          withdrawn: summary.aglpWithdrawn,
                          totalEarned:
                              summary.aglpBalance + summary.aglpWithdrawn,
            ...
            children: [
              ...
              TextField(
                ...
                decoration: InputDecoration(
                  ...
                  hintText: 'Full name as on account',
                  border: OutlineInputBorder(
                    borderRadius: BorderRadius.circular(12),
                  ),
                ),
                ...
                Container(
                  ...
                  child: Column(
                    children: [
                      ...
                      //         value:
                      //             '${pendingCommissions.toStringAsFixed(0)} AGLP',
                      //         color: AppColors.successGreen.withValues(
                      //           alpha: 0.8,
                      //         ),
                      //       ),
                      ...
                      //         value:
                      //             '${pendingWithdrawals.toStringAsFixed(0)} AGLP',
...
class _ReferralCard extends HookConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final referralData = useState<ReferralData?>(
      user?.referralCode != null
          ? ReferralData(
              code: user!.referralCode!,
              link: 'https://erkata.app/register?ref=${user.referralCode}',
            )
          : null,
    );
    ...
    final handleGenerate = useCallback(() async {
      ...
      try {
        ...
        // Optionally update the user profile in state if needed,
        // but the next refresh will handle it.
      } catch (e) {
        error.value = "Failed to generate referral code";
      } finally {
    ...
    final handleCopy = useCallback(() async {
      if (referralData.value != null) {
        // We copy the code to be in sync with web dashboard,
        // or we can copy the link if that's more useful.
        // User said "generates a link instead of code", so showing the code is key.
        await Clipboard.setData(ClipboardData(text: referralData.value!.code));
        isCopied.value = true;
